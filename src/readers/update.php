...
<head>
    ...
    <title>Update Borrowers Data</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <center>
            <h1><i class="fa-solid fa-pen-to-square"></i> Update <?= $data['name']?></h1>
            <br>
        </center>
            <div class="row">
                <div class="col">
            ...
            <center>
                <a href="readers.php" type="submit" class="btn btn-danger">Cancel</a> 
